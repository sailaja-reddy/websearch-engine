...
import com.kwit.spider.QueryProcessor;

public class Energy_Efficient_Query_Processing
{
	private static final String syntax = " StressCrawler <url> [ thread count ]";
	public static void EEQuery(String[] args)
	{
	...
	public Energy_Efficient_Query_Processing(String base)
	{
		this.base = base;
	}
...
class StressTestSpider extends QueryProcessor
{
